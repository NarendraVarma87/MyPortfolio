...
export default function ContactMe() {
  return (
    <div className='container pt-5' id="contact">
        ...
        <div className='col-12 col-md-6  text-center  h5' style={{border : '1px solid white',marginTop:'30px'}}>
          <h5 className='text-center text-decoration-underline my-3 text-warning '>Drop your details Here</h5>
          {<Contact/>}
        </div>
     </div>
    </div>
