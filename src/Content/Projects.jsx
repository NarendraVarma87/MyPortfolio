      ...
      <div className="row">
           <div className="col-12 col-md-6 col-lg-4">
                <div className="project-card m-2" style={{border:'1px solid white'}}>
                  <img src="/src/assets/fullstack.webp" alt="Project 1 Image" width='30%' height='25%' className='my-1'/>
             ...
             <div className="col-12 col-md-6 col-lg-4">
                <div className="project-card m-2" style={{border:'1px solid white'}}>
                <img src="/src/assets/form-validation.jpeg" alt="Project 2 Image"  width='30%' height='25%' className='my-1'/>
             ...
             <div className="col-12 col-md-6 col-lg-4">
                <div className="project-card m-2" style={{border:'1px solid white'}}>
                <img src="/src/assets/blog.png" alt="Project 1 Image" width='30%' height='25%' className='my-1'/>
             ...
             <div className="col-12 col-md-6 col-lg-4">
                <div className="project-card m-2" style={{border:'1px solid white'}}>
                <img src="/src/assets/spring.png" alt="Project 1 Image"  width='30%' height='25%' className='my-1'/>
             ...
             <div className="col-12 col-md-6 col-lg-4 ">
                <div className="project-card m-2" style={{border:'1px solid white'}}>
                <img src="/src/assets/reaction.png" alt="Project 1 Image"  width='30%' height='25%' className='my-1'/>
